...
export const Route = createFileRoute("/admin/cuentas")() ({
  head: () => ({
    meta: [
      { title: "Cuentas — MA² Digital" },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-xl px-4 pb-16 pt-4">
        <div className="rounded-2xl border border-border bg-card p-6 text-center">
          <p className="text-sm text-muted-foreground">TODO: Gestión de cuentas de streaming - Conectar a Supabase</p>
        </div>
      </main>
    </div>
  );
